...
<style>
    .datepicker.datepicker-dropdown {
        z-index: 9999 !important; /* This is the key fix */
    }
</style>
                            ...
                            <table id="datatable" class="table table-hover table-bordered table-striped dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                <thead>
                                    <tr>
                                        ...
                                        <th>NIS</th>
                                        <th>Nama Lengkap</th>
                                        <th>Jenis Kelamin</th> <th>Kelas</th>
                                        <th>Tahun Masuk</th>
                                        <th>Nama Wali</th>
                                        <th>No HP Wali</th>
                                        <th>Status</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                                $gender_text = $row['jenis_kelamin'] == 'L' ? 'Laki-laki' : 'Perempuan';
                                                $gender_badge_class = $row['jenis_kelamin'] == 'L' ? 'primary' : 'pink'; // Contoh warna badge
                                            ?>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                ...
                                                <button type="button" class="btn btn-sm btn-warning" onclick="editStudent(<?php echo htmlspecialchars(json_encode($row)); ?>)" title="Edit">
                                                    <i class="mdi mdi-pencil"></i>
                                                </button>
                                                <button type="button" class="btn btn-sm btn-danger" onclick="deleteStudent(<?php echo $row['id']; ?>, '<?php echo htmlspecialchars($row['nama_lengkap']); ?>')" title="Hapus">
...
$custom_js = "
    $(document).ready(function() {
        if (typeof $.fn.DataTable !== 'undefined') {
            $('#datatable').DataTable({
                ...
                columnDefs: [
                    ...
                    { responsivePriority: 7, targets: 3 },   // Jenis Kelamin (previously JK)
        ...
        $('.yearpicker').datepicker({
            format: 'yyyy',         // Hanya format tahun
            viewMode: 'years',      // Tampilkan hanya mode tahun
            minViewMode: 'years',   // Minimum tampilan adalah tahun
            autoclose: true,        // Otomatis tutup setelah memilih
            orientation: 'bottom',  // Muncul di bawah input
            // opsional: atur range tahun
            startDate: '2000',      // Tahun awal yang bisa dipilih
            endDate: '" . date('Y') . "' // Tahun akhir (tahun sekarang)
        });
        ...
        $('#editModal').on('shown.bs.modal', function () {
            // Data sudah diisi oleh editStudent, kita hanya perlu memastikan datepicker diupdate
    ...
    function editStudent(student) {
        ...
        $('#edit_kelas_id').val(student.kelas_id);
        $('#edit_tahun_masuk').val(student.tahun_masuk); // Ini akan mengisi nilai tahun
